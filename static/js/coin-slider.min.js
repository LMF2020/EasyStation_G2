...
(function ($) {
    ...
    $.fn.coinslider = $.fn.CoinSlider = function (options) {
        init = function (el) {
            ...
            function (i, item) {
                // ++ 修改加上linkto
                linktoArr[el.id][i] = $(item).attr('linkto');
            ...
            // ++ 修改加上linkto
            $(el).attr('linkto',linktoArr[el.id][0])

            $(el).css({
                'background-image': 'url(' + images[el.id][0] + ') no-repeat',
        ...
        $.transition = function (el, direction) {
            ...
            // ++ 修改加上linkto
            $(el).attr('linkto',linktoArr[el.id][imagePos[el.id]]);
        ...
        $.appereance = function (el, sid) {
            ...
            var size = params[el.id].width + 'px ' + params[el.id].height + 'px';
            $('#cs-' + el.id + sid).css({
                opacity: 0,
                'background-image': 'url(' + images[el.id][imagePos[el.id]] + ') ',
        ...
        $.setNavigation = function (el) {
            ...
            for (k = 1; k < images[el.id].length + 1; k++) {
                $('#cs-buttons-' + el.id).append("<a href='#' class='cs-buttons-a cs-button-" + el.id + "' id='cs-button-" + el.id + "-" + k + "'>" + k + "</a>");
            }
